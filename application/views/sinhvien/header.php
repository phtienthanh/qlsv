...
<html lang="en">
            ...
            <div class="container">
                <div class="row margin-vert-40">
                    ...
                    <div class="col-md-12">
                        ...
                        <img class="fadeInUp animate" alt="" src="<?php echo base_url();?>asset/img/responsive_homepage.jpg" style="display: block; margin-left: auto; margin-right: auto; margin-top: 40px;">
                    </div>
                    <!-- End Main Text -->
                </div>
            </div>
                        ...
                        <a href="#">
                            <figure class="animate fadeInLeft">
                                <div class="grid-image">
                                    ...
                                    <img alt="image1" src="<?php echo base_url();?>asset/img/frontpage/image1.jpg">
                                </div>
                            </figure>
                        </a>
                    </div>
                        ...
                        <a href="#">
                            <figure class="animate fadeInUp">
                                <div class="grid-image">
                                    ...
                                    <img alt="image2" src="<?php echo base_url();?>asset/img/frontpage/image2.jpg">
                                </div>
                            </figure>
                        </a>
                    </div>
                        ...
                        <a href="#">
                            <figure class="animate fadeInRight">
                                <div class="grid-image">
                                    ...
                                    <img alt="image3" src="<?php echo base_url();?>asset/img/frontpage/image3.jpg">
                                </div>
                            </figure>
                        </a>
                    </div>
                        ...
                        <a href="#">
                            <figure class="animate fadeInLeft">
                                <div class="grid-image">
                                    ...
                                    <img alt="image4" src="<?php echo base_url();?>asset/img/frontpage/image4.jpg">
                                </div>
                            </figure>
                        </a>
                    </div>
                        ...
                        <a href="#">
                            <figure class="animate fadeInUp">
                                <div class="grid-image">
                                    ...
                                    <img alt="image5" src="<?php echo base_url();?>asset/img/frontpage/image5.jpg">
                                </div>
                            </figure>
                        </a>
                    </div>
                        ...
                        <a href="#">
                            <figure class="animate fadeInRight">
                                <div class="grid-image">
                                    ...
                                    <img alt="image6" src="<?php echo base_url();?>asset/img/frontpage/image6.jpg">
                                </div>
                            </figure>
                        </a>
                    </div>
                        ...
                        <a href="#">
                            <figure class="animate fadeInLeft">
                                <div class="grid-image">
                                    ...
                                    <img alt="image7" src="<?php echo base_url();?>asset/img/frontpage/image7.jpg">
                                </div>
                            </figure>
                        </a>
                    </div>
                        ...
                        <a href="#">
                            <figure class="animate fadeInUp">
                                <div class="grid-image">
                                    ...
                                    <img alt="image8" src="<?php echo base_url();?>asset/img/frontpage/image8.jpg">
                                </div>
                            </figure>
                        </a>
                    </div>
                        ...
                        <a href="#">
                            <figure class="animate fadeInRight">
                                <div class="grid-image">
                                    ...
                                    <img alt="image9" src="<?php echo base_url();?>asset/img/frontpage/image9.jpg">
                                </div>
                            </figure>
                        </a>
                    </div>
  ...
  <script type="text/javascript">$('#logout_section').hide();
  $('.manage_login').hide();
  </script>
    ...
    ?>
    <script type="text/javascript">$('#login_section').hide();</script>
    <?php
    }
    ?>
            <!-- End Footer -->
