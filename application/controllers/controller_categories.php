...
class Controller_categories extends MY_Controller {
...
public function add(){
    ...
    $this->form_validation->set_message('is_unique','%s đã tồn tại');
        ...
        header('Location:'.base_url("/Controller_categories/add"));  
    ...
    $this->load->view('view_categories/add_show',$this->data);
        ...
        $this->load->view("view_categories/update",$data);
